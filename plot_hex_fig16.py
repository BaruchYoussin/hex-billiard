...
plotting_lib.mpf_plot(ax, orbits_data_and_colors,
                      xlow=0.06476, xhigh=0.064762, ylow=0.4806888,
                      yhigh=0.48068895, xticks_num=5, yticks_num=4)
ax.set_xlabel("phi", loc="right")
ax.set_ylabel("p", loc="top", rotation=0)
# plt.setp(ax.get_xticklabels(), rotation=45, horizontalalignment='right')
fig.savefig("plots_hex/plot_hex_fig16.png")
